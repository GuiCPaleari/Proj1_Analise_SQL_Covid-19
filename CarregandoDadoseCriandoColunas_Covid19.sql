# Criando colunas tudo como tipo texto para evitar erros nas hora do carregamento dos dados.
# Depois que carregar os dados sem problemas, vou até a tabela e altero o tipo de dado conforme preciso.
...
# Carregando os dados via linha de comando
LOAD DATA LOCAL INFILE 'C:/Users/Guipa/Desktop/Dataset_Covid19/covid_mortes.csv' INTO TABLE `cap07`.`covid_mortes` CHARACTER SET UTF8
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'C:/Users/Guipa/Desktop/Dataset_Covid19/covid_vacinacao.csv' INTO TABLE `cap07`.`covid_vacinacao` CHARACTER SET UTF8
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
